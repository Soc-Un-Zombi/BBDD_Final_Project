 ...
 */
public class Eliminar_seu extends javax.swing.JDialog {
     ...
     * @param modal 
     */
    public Eliminar_seu(java.awt.Frame parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        //pare = parent;
    ...
    public Eliminar_seu(Veure.Veure_Seus parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare_d = parent;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Atenció!!! Elimina o modifica tota la informació que estigui lligada a aquesta seu abans de eliminar la seu!!! (excepte l'adreça)");
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        String ordre = "DELETE FROM address a, headquarters h WHERE h.addressid= a.addressid AND h.headquarterid='"+id+"';";
        System.out.println(ordre);
        ordre = "DELETE FROM headquarters WHERE headquarterid='"+id+"';";
        System.out.println(ordre);
        executeQuery(con, ordre);
        cerca_base_dades();
        pare_d.cerca_base_dades();
    ...
    */
    private void cerca_base_dades(){
        update_list("SELECT headquarterid, headquartername FROM headquarters;");
