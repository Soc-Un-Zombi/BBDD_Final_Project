 ...
 */
public class Eliminar_delicte extends javax.swing.JDialog {
    ...
    Veure.Veure_Antecedents pare_v;
    Modifica.Modificar_personal pare_m;
    public Eliminar_delicte(java.awt.Frame parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare = parent;
    ...
    public Eliminar_delicte(Veure.Veure_Antecedents parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare_v = parent;
    ...
    public Eliminar_delicte(Modifica.Modificar_personal parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare_m = parent;
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        String ordre = "DELETE FROM criminalrecord WHERE crimeid='"+id+"';";
    ...
    private void cerca_base_dades(){
        update_list("SELECT crimeid, crime, jurydate, jailin, jailout  FROM criminalrecord;");
        
    }
    
    private void cerca_base_dades(int id){
        update_list("SELECT crimeid, crime, jurydate, jailin, jailout  FROM criminalrecord WHERE memberid="+id+ ";");
