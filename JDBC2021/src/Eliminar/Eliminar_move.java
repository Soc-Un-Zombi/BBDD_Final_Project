 ...
 */
public class Eliminar_move extends javax.swing.JDialog {
    ...
    public Eliminar_move(Veure.Veure_Diners parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare = parent;
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        id = id.replaceAll("\\s+","");
        String ordre = "DELETE FROM moves WHERE moveid='"+id+"';";
    ...
    */
    private void cerca_base_dades(){
        update_list("SELECT moveid, deposit, movedesc, date from moves;");
