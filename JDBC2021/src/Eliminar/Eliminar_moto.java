 ...
 */
public class Eliminar_moto extends javax.swing.JDialog {
    ...
    public Eliminar_moto(Veure.Veure_Motos parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare_v = parent;
    ...
    public Eliminar_moto(java.awt.Frame parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare = parent;
    ...
    public Eliminar_moto(Modifica.Modificar_personal parent, Connection c, boolean modal) {
        super(parent, modal);
        initComponents();
        con = c;
        pare_m = parent;
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarActionPerformed
        ...
        */
        ...
        String ordre = "DELETE FROM bikes WHERE licenseplate='"+license+"';";
    ...
    */
    private void cerca_base_dades(){
        update_list("SELECT * from elimina_moto;");
        
    }
    
    private void cerca_base_dades(int id){
        update_list("SELECT * from elimina_moto WHERE memberid="+id+";");
